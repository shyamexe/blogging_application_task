...
class PostResponseModel {
  ...
  PostResponseModel({this.kind, this.nextPageToken, this.items, this.etag});
...
class Items {
  ...
  @override
  String toString() {
    return 'Items(kind: $kind, id: $id, blog: $blog, published: $published, updated: $updated, url: $url, selfLink: $selfLink, title: $title, content: $content, author: $author, replies: $replies, etag: $etag)';
  }
}
...
class Author {
  ...
  @override
  String toString() {
    return 'Author(id: $id, displayName: $displayName, url: $url, image: $image)';
  }
}
